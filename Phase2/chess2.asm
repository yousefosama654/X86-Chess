...
.data
    ...
    invite_chatmsg          db      'wait for accepting your invitation for chating','$'
    have_invite_chatmsg     db      'you have invitation  for chating','$'
    me                      db      "Me:",'$'
    You                     db      "You:",'$'
...
Team2_set_highlighled_true endp
    ...
    ;clear the sender part of the inline chat
ClearInlineTop PROC
    ...
    InlineExit1:                         
                                         ...
                                         ret
ClearInlineTop ENDP
    ;clear the reciever part of the inline chat
